...
namespace Coherence.Generated
{
	...
	public class Binding_677cc6adb825e4f698f676c7c8341d73_44b9bd18_e111_4219_a771_c7c91a49f6ef : PositionBinding
	{
	...
	public class Binding_677cc6adb825e4f698f676c7c8341d73_824a62fb_0d41_4fd4_9849_88c7b7f32769 : RotationBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'Fireball' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncFireball_id2 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncFireball_id2>();
			if (coherenceSync.TryGetBindingByGuid("44b9bd18-e111-4219-a771-c7c91a49f6ef", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_677cc6adb825e4f698f676c7c8341d73_44b9bd18_e111_4219_a771_c7c91a49f6ef();
			...
			if (coherenceSync.TryGetBindingByGuid("824a62fb-0d41-4fd4-9849-88c7b7f32769", "rotation", out Binding InternalWorldOrientation_Rotation_value))
			{
				var clone = new Binding_677cc6adb825e4f698f676c7c8341d73_824a62fb_0d41_4fd4_9849_88c7b7f32769();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncFireball_id2] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
