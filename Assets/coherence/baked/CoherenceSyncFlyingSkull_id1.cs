...
namespace Coherence.Generated
{
	...
	public class Binding_231416ec400cc4773a6f82624f7cacb2_1184b4f5_ca87_4b02_98e3_a39cfa10f083 : PositionBinding
	{
	...
	public class Binding_231416ec400cc4773a6f82624f7cacb2_47fc2a4a_ab60_41b9_bdbf_7a2efd9dfa87 : RotationBinding
	{
	...
	[Preserve]
	[AddComponentMenu("coherence/Baked/Baked 'FlyingSkull' (auto assigned)")]
	[RequireComponent(typeof(CoherenceSync))]
	public class CoherenceSyncFlyingSkull_id1 : CoherenceSyncBaked
	{
		...
		protected void Awake()
		{
			...
			logger = coherenceSync.logger.With<CoherenceSyncFlyingSkull_id1>();
			if (coherenceSync.TryGetBindingByGuid("1184b4f5-ca87-4b02-98e3-a39cfa10f083", "position", out Binding InternalWorldPosition_Translation_value))
			{
				var clone = new Binding_231416ec400cc4773a6f82624f7cacb2_1184b4f5_ca87_4b02_98e3_a39cfa10f083();
			...
			if (coherenceSync.TryGetBindingByGuid("47fc2a4a-ab60-41b9-bdbf-7a2efd9dfa87", "rotation", out Binding InternalWorldOrientation_Rotation_value))
			{
				var clone = new Binding_231416ec400cc4773a6f82624f7cacb2_47fc2a4a_ab60_41b9_bdbf_7a2efd9dfa87();
		...
		public override void ReceiveCommand(IEntityCommand command)
		{
			...
			{
				default:
					logger.Warning($"[CoherenceSyncFlyingSkull_id1] Unhandled command: {command.GetType()}.");
					break;
			}
		}
	}
